...
class Client(smart_home.HomeDevice.Client, Iface):
    ...
    def getOpenClosedMode(self):
        self.send_getOpenClosedMode()
        return self.recv_getOpenClosedMode()

    def send_getOpenClosedMode(self):
        self._oprot.writeMessageBegin('getOpenClosedMode', TMessageType.CALL, self._seqid)
        args = getOpenClosedMode_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getOpenClosedMode(self):
        iprot = self._iprot
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            raise x
        result = getOpenClosedMode_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getOpenClosedMode failed: unknown result")
...
class Processor(smart_home.HomeDevice.Processor, Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["getOpenClosedMode"] = Processor.process_getOpenClosedMode
    ...
    def process_getOpenClosedMode(self, seqid, iprot, oprot):
        args = getOpenClosedMode_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getOpenClosedMode_result()
        try:
            result.success = self._handler.getOpenClosedMode()
        ...
        oprot.writeMessageBegin("getOpenClosedMode", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class getOpenClosedMode_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('getOpenClosedMode_args')
...
all_structs.append(getOpenClosedMode_args)
getOpenClosedMode_args.thrift_spec = (
)


class getOpenClosedMode_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getOpenClosedMode_result')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getOpenClosedMode_result)
getOpenClosedMode_result.thrift_spec = (
